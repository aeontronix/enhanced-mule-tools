...
## [1.4.0](https://gitlab.com/aeontronix/oss/enhanced-mule/enhanced-mule-tools/-/releases/v1.4.1)

### Added

- Interactive browser-based authentication
- Properties en/decryption (for enhanced mule properties)

## [1.3.3](https://gitlab.com/aeontronix/oss/enhanced-mule/enhanced-mule-tools/-/releases/v1.3.3)

### Fixed

- Prepare for publish not setting credentials in distribution management
